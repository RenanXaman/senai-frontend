...
async function getData() {
    const response = await fetch("https://api.zerosheets.com/v1/wvt");
...
async function patchRow(lineNumber, payload) {
    ...
    */
    const url = "https://api.zerosheets.com/v1/wvt/" + lineNumber;
...
async function deleteRow(lineNumber) {
    const url = "https://api.zerosheets.com/v1/wvt/" + lineNumber; // lineNumber comes from the get request
    await fetch(url, {
        method: "DELETE"
    });
